...
function add_cart(){
    ...
    if(isset($_GET['add_cart'])){
        ...
        $p_id = $_GET['add_cart'];
        $prouct_qty = $_POST['product_qty'];
        $prouct_size = $_POST['product_size'];
        ...
        if(mysqli_num_rows($run_check)>0){
            ...
            $query = "insert into cart (p_id,ip_add,qty,size) values ('$p_id','$ip_add','$prouct_qty','$prouct_size')";
...
function getpcatpro(){
    ...
    if(isset($_GET['p_cat'])){
        ...
        if($count==0){
            echo "
                <div class='box'>
                    <h1> No Products Found In This Product Cateogries </h1>
