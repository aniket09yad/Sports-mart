    ...
    <div class="container"><!-- container Begin -->
        ...
        <div class="col-md-9"><!-- col-md-9 Begin -->
            ...
            <div class='box'><!-- box Begin -->
                <h1>Shop</h1>
                <p>
                    Welcome to our sports shop, where we aim to provide you with everything you need to achieve your 
                    fitness and athletic goals. Our shop is filled with high-quality equipment and apparel from top brands,
                     ensuring that you have access to the best gear on the market.Our range includes sports shoes, athletic wear, workout accessories, and specialized equipment for various sports.
                </p>
            </div><!-- box Finish -->
...
<script>
    ...
    $(document).ready(function () {
        ...
        // Finish Search Filters | by letters //
