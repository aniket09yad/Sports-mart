        ...
        <div class="container"> <!-- container Begin -->
            ...
            <div class="box"> <!-- box Begin -->
                <div class="box-header"> <!-- box-header Begin -->
                    ...
                    <input type="password" class="form-control" name="c_pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
                    ...
                    <input type="number"  class="form-control" value="+91" name="c_contact" required>
