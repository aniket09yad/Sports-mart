    ...
    <div id="top"> <!-- Top begin -->
        <div class="container"> <!-- Container  begin -->
            <div class="col-md-6 offer"> <!-- coi md-6 offer begin  -->
                ...
                <a href="checkout.php">
                    <?php items(); ?> Items In Your Cart | Total Price:
                    <?php total_price(); ?>
                </a>
        ...
        <div class="container"> <!-- container begin -->
            <div class="navbar-header"> <!-- navbar-header begin -->
                <a href="index.php" class="navbar-brand home"> <!-- navbar-brand home Begin -->
                    ...
                    <img src="images\---cbf027f6-bc1b-4d93-b3a7-c3700ef82193.png" alt="Sport-Mart Logo"
                        class="hidden-xs">
                    <img src="images\---cbf027f6-bc1b-4d93-b3a7-c3700ef82193.png" alt="Sport-Mart Logo Mobile"
                        class="visible-xs">
                    ...
                    <div class="col-sm-6"><!-- col-sm-6 Begin -->
                        <div class="box"><!-- box Begin -->
                            ...
                            <form class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                                ...
                                <p class="text-center buttons"><button type="submit" name="add_cart" class="btn btn-primary i fa fa-shopping-cart">
